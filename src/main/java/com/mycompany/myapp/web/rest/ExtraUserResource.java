    ...
    public ResponseEntity<ExtraUser> partialUpdateExtraUser(
        ...
        Optional<ExtraUser> result = extraUserRepository
            ...
            .map(existingExtraUser -> {
                ...
                if (extraUser.getLieuNaissance() != null) {
                    existingExtraUser.setLieuNaissance(extraUser.getLieuNaissance());
                }
                ...
                if (extraUser.getNomArabe() != null) {
                    existingExtraUser.setNomArabe(extraUser.getNomArabe());
                }
                if (extraUser.getPrnomArabe() != null) {
                    existingExtraUser.setPrnomArabe(extraUser.getPrnomArabe());
                }

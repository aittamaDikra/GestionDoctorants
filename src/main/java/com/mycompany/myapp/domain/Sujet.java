...
public class Sujet implements Serializable {
    ...
    public String getCoencadrent() {
        return this.coencadrent;
    }

    public Sujet coencadrent(String coencadrent) {
        this.setCoencadrent(coencadrent);
        return this;
    }

    public void setCoencadrent(String coencadrent) {
